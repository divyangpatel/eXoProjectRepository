...
<!-- <div id ="validationMsg" class="validateUser"></div> -->
 <div id="validationMsg" title="Validation Message" style="/* background-color: yellow; border: 1px dashed black; font-size: 18px;font-weight: bold;margin-left: 275px;width: 50%; */">
</div>
